      ...
      (list
       ...
       (when (and equity (> equity 0))
         (cond ;; The Equity Lords
          ...
          ((s-equals? name "prodzpod") "🌠🌌🎑") ;; owed 1 emote
          ...
          ((s-equals? name "trap_exit") (s-concat (propertize "Q" 'display (create-image (w/twitch-emote-path "emotesv2_dfc4c36ccd3b4994b8ca4f082230f053"))) "☠💀"))
